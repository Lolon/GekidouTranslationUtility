...
public class PnnQuantizer
{
    ...
    public List<SKColor> GetPaletteFromImages(IEnumerable<SKBitmap> bitmaps, int nMaxColors, bool firstTransparent = false)
    {
...
//     public void QuantizeImage(SKBitmap source, TexturePaletteLibrary dest, int nMaxColors, bool texture, bool dither, bool firstTransparent, bool replacePalette, int replPal)
//     {
...
//         SKColor[] palette;
//         //TODO: solve assumption of only one color palette
//         if (dest.Palettes[0].Colors.Count < nMaxColors)
//         {
//             palette = [.. dest.Palettes[0].Colors, .. new SKColor[nMaxColors - dest.Palettes[0].Colors.Count]];
//         }
//         else
//         {
//             if (replPal > 0)
...
//                 palette = [.. dest.Palettes[0][(16 * replPal)..(16 * (replPal + 1))]];
//             }
//             else
//             {
//                 palette = [.. dest.Palettes[0]];
//             }
//         }
//         if (firstTransparent)
//         {
